<?php
add_action( 'wp_ajax_tb_fixtures_shortcode', 'tb_fixtures_shortcode_ajax' );

function tb_fixtures_shortcode_ajax() {
	$defaults = array(
		'limit' => 5,
		'comp' => null,
		'season' => null,
	...
	?>
		<div id="tb_fixtures-form">
			<table id="tb_fixtures-table" class="form-table">
				<tr>
					<?php $field = 'title'; ?>
			...
			<p class="submit">
				<input type="button" id="option-submit" class="button-primary" value="<?php printf( __( 'Insert %s', 'themeboy' ), __( 'Fixtures', 'themeboy' ) ); ?>" name="submit" />
			</p>
		</div>
	<?php
	exit();
